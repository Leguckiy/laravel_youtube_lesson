            ...
            <div>
                ...
                @foreach ([
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" class="form-check-input m-0" name="{{ $field }}" id="{{ $field }}"
                                @if(isset($coupon->$field) && $coupon->$field === 1)
                                    {{ "checked" }}
                                @endif
                            >
                        </div>
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="date" class="form-control" name="expired_at" id="expired_at"
                               value="{{ old('expired_at', $coupon->expired_at->format('d/m/Y') ?? '') }}">
                    </div>
                </div>
                <br>
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
						...
						<textarea name="description" id="description" cols="72"
                            rows="7">{{ old('description', $coupon->description ?? '') }}
                        </textarea>
                    </div>
                </div>
                <br>
