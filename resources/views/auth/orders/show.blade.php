                    ...
                    <table class="table table-striped">
                        ...
                        @foreach ($skus as $sku)
                            <tr>
                                ...
                                <td><span class="badge rounded-pill bg-success">{{ $sku->pivot->count }}</span></td>
                        ...
                        @if ($order->hasCoupon())
                            <tr>
                                <td>Был использован купон:</td>
                                <td><a href="{{ route('coupons.show', $order->coupon) }}">{{ $order->coupon->code }}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
